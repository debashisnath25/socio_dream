		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar67-sm.jpg" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar62-sm.jpg" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar68-sm.jpg" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar69-sm.jpg" class="avatar">
				...
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar70-sm.jpg" class="avatar">
						<span class="icon-status disconected"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar64-sm.jpg" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar71-sm.jpg" class="avatar">
						<span class="icon-status online"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar72-sm.jpg" class="avatar">
						<span class="icon-status away"></span>
					</div>
				</li>
				<li class="inline-items js-chat-open">
					<div class="author-thumb">
						<img alt="author" src="images/avatar63-sm.jpg" class="avatar">
			...
			<div class="ui-block">
				<div class="top-header">
					<div class="top-header-thumb">
						<img src="images/top-header1.jpg" alt="nature">
					</div>
					...
					<div class="top-header-author">
						<a href="02-ProfilePage.html" class="author-thumb">
							<img src="images/author-main1.jpg" alt="author">
						</a>
					...
					<article class="hentry post video">
							...
							<div class="post-video">
								<div class="video-thumb">
									<img src="images/video5.jpg" alt="photo">
				...
				<div class="ui-block">
					...
					<ul class="comments-list">
						...
						<li class="has-children">
							<div class="post__author author vcard inline-items">
								<img src="images/avatar5-sm.jpg" alt="author">
							...
							<ul class="children">
								<li>
									<div class="post__author author vcard inline-items">
										<img src="images/avatar8-sm.jpg" alt="author">
								...
								<li>
									<div class="post__author author vcard inline-items">
										<img src="images/avatar2-sm.jpg" alt="author">
				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail shared-photo">
							...
							<div class="post-thumb">
								<img src="images/post-photo6.jpg" alt="photo">
							</div>
			...
			<div class="ui-block">
				...
				<div class="ui-block-content">
					...
					<ul class="widget w-last-photo js-zoom-gallery">
						<li>
							<a href="images/last-photo10-large.jpg">
								<img src="images/last-photo10-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot11-large.jpg">
								<img src="images/last-phot11-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot12-large.jpg">
								<img src="images/last-phot12-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot13-large.jpg">
								<img src="images/last-phot13-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot14-large.jpg">
								<img src="images/last-phot14-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot15-large.jpg">
								<img src="images/last-phot15-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot16-large.jpg">
								<img src="images/last-phot16-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot17-large.jpg">
								<img src="images/last-phot17-large.jpg" alt="photo">
							</a>
						</li>
						<li>
							<a href="images/last-phot18-large.jpg">
								<img src="images/last-phot18-large.jpg" alt="photo">
							</a>
						</li>
					</ul>
			...
			<div class="ui-block">
				...
				<div class="ui-block-content">
					...
					<ul class="widget w-faved-page js-zoom-gallery">
						...
						<li>
							<a href="#">
								<img src="images/avatar24-sm.jpg" alt="user">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar36-sm.jpg" alt="author">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar35-sm.jpg" alt="user">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar34-sm.jpg" alt="author">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar33-sm.jpg" alt="author">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar32-sm.jpg" alt="user">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar31-sm.jpg" alt="author">
							</a>
						</li>
						<li>
							<a href="#">
						...
						<li>
							<a href="#">
								<img src="images/avatar26-sm.jpg" alt="user">
							</a>
						</li>
						<li>
							<a href="#">
								<img src="images/avatar25-sm.jpg" alt="user">
							</a>
						</li>
						<li class="all-users">
							<a href="#">+74</a>
