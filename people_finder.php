...
<head>
	...
	<title>Blog Version1 Masonry</title>
...
<div class="main-header">
	...
	<img class="img-bottom" src="images/blog_bottom.png" alt="friends">
</div>
...
<div class="container">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post10.jpg" alt="photo">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-additional-info inline-items">
						...
						<ul class="friends-harmonic">
							<li>
								<a href="#">
									<img src="images/icon-chat28.png" alt="icon">
								</a>
							</li>
						</ul>
						<div class="names-people-likes">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post11.jpg" alt="photo">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post6.jpg" alt="photo">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post5.jpg" alt="photo">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post12.jpg" alt="photo">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post7.jpg" alt="photo">
		...
		<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 sorting-item">
			<div class="ui-block">
				...
				<article class="hentry blog-post blog-post-v1">
					...
					<div class="post-thumb">
						<img src="images/post8.jpg" alt="photo">
	...
	<a id="load-more-button" href="#" class="btn btn-control btn-more" data-load-link="posts-load-more.html" data-container="posts-grid-1">
		<svg class="olymp-three-dots-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-three-dots-icon"></use></svg>
	</a>
</div>
